...
conda deactivate
conda create -n minimap2 -y minimap2=2.20 bcftools=1.12 samtools=1.12
...
conda deactivate
conda create -n svim -y svim-asm=1.0.2 bcftools=1.12
conda activate svim

svim-asm diploid hg002 v12_NA24385_hpg_pbsq2-ccs_1000-pereg.h1-un.racon-p2.sorted.bam v12_NA24385_hpg_pbsq2-ccs_1000-pereg.h2-un.racon-p2.sorted.bam ../ref/human_g1k_v37.fasta.gz
